...
function ChatContainer({ displayName, messages }) {
  return (
    <main className="flex-1 flex flex-col bg-[#313338] text-slate-200">
      <div className="h-16 px-6 flex items-center justify-between border-b border-black/20">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-slate-500">Söhbət</p>
          <h2 className="text-lg font-semibold">Xoş gəldin, {displayName}</h2>
        </div>
